...
/**
 * Alias backward-compat: consumer lama (`useProfile`, `DashboardLayout`,
 * `useLamFilter`, `RoleContext`, `Login`) meng-import `useAuth` langsung dari
 * context ini. Sumber kebenaran tetap `useAuthContext` di atas.
 */
