import { Briefcase, Clock, Target, Rocket, DollarSign, MapPin, Camera, Building2 } from "lucide-react";
...
const summary = [
  ...
  { title: "Kerja ≤ 6 bln", value: "85%", hint: "Lulusan cepat terserap", trend: "+7%", trendUp: true, icon: Clock, color: "bg-amber-500/10 text-amber-500" },
  ...
  { title: "Rata-rata Pendapatan", value: "Rp 9,1 jt", hint: "71% ≥ 1,2× UMP", trend: "+8%", trendUp: true, icon: DollarSign, color: "bg-primary/10 text-primary" },
  { title: "Level Nasional", value: "47%", hint: "Sebaran perusahaan utama", icon: Building2, color: "bg-purple-500/10 text-purple-500" },
];
        ...
        <Tabs defaultValue="k4" className="space-y-4">
          <TabsList className="flex flex-wrap h-auto bg-muted/40 p-1.5 rounded-xl gap-1.5">
            {[
              ...
              <TabsTrigger key={v} value={v} className="gap-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow rounded-lg px-4 py-2.5 transition-all">
