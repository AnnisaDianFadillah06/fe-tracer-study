...
const dashboardItems: MenuItem[] = [
  ...
  { title: "KPI IKU", href: "/dashboard/kpi", icon: BarChart3, description: "12 indikator KPI & threshold LAM", permission: "dashboard.kpi" },
];
...
const adminItems: MenuItem[] = [
  ...
  { title: "Master UMP", href: "/dashboard/master-ump", icon: Building2, description: "UMP per provinsi per tahun", permission: "admin.master" },
  { title: "Threshold LAM", href: "/dashboard/threshold-management", icon: ShieldCheck, description: "Ambang batas indikator per LAM", permission: "admin.master" },
  { title: "Pemetaan Pertanyaan", href: "/dashboard/question-mapping", icon: ClipboardList, description: "Mapping soal ke semantic role", permission: "admin.master" },
  { title: "Log Anomali ETL", href: "/dashboard/etl-anomaly-log", icon: ShieldCheck, description: "Audit anomali pipeline ETL", permission: "admin.master" },
];
...
export const routePermissionMap: Record<string, Permission> = {
  ...
  "/dashboard/master-ump": "admin.master",
  "/dashboard/threshold-management": "admin.master",
  "/dashboard/question-mapping": "admin.master",
  "/dashboard/etl-anomaly-log": "admin.master",
